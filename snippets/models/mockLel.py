...
class MockLel:
    ...
    def lelMockeado(self):
        lel1 = Lel(Termino.VERBO,  'Administer', ''' Action performed by a doctor, 
        that consists in dispensing at a certain date and hour a dose of a drug to deal with some 
        disease of a patient in some seriousness in order to obtain some outcome.''')
...
is to treat patients. The doctor works for a hospital and belongs to a Department.''')
        ...
        lel8 = Lel(Termino.OBJETO, ' Hour', ''' One of the 24 parts that a day is divided
into.''')
        lel9 = Lel(Termino.OBJETO, 'Date', ''' A particular day of a month, in a particular
year.
''')
...
drug completely''')
        lel13 = Lel(Termino.Objeto, 'Physiological effect', '''The expected result of administering 
...
a year is divided.''')
        ...
        lel22 = Lel(Termino.OBJETO, 'Gender', '''A range of identities with reference to social
and cultural differences.''')
        lels = []
        lels.append(lel1, lel2, lel3, lel4, lel5, lel6, lel7, lel8, lel9, lel10, lel11, lel12, lel13, lel14, lel15, lel16, lel17, lel18, lel19, lel20, lel21, lel22)
